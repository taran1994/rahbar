    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-9" id="myprofile">
          ...
          <?php 
          if(isset($selector_profile)){
            ?>
          <form class="needs-validation" action="/SelectorApi/update" method="put" nonvalidate>
            <?php
          foreach ($selector_profile as $profile)
          {?>
          ...
          <?php } } else {?>
            <form class="needs-validation" action="/SelectorApi/save" method="put" nonvalidate>
