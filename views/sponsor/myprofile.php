    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-9" id="myprofile">
          ...
          <?php 
          if(isset($sponsor_profile)){
            ?>
          <form class="needs-validation" action="/SponsorApi/update" method="put" nonvalidate>
            <?php
          foreach ($sponsor_profile as $profile)
          {?>
          ...
          <?php } } else {?>
            <form class="needs-validation" action="/SponsorApi/save" method="put" nonvalidate>
