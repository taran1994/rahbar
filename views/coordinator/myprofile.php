    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-9" id="myprofile">
          ...
          <?php 
          if(isset($coordinator_profile)){
            ?>
          <form class="needs-validation" action="/CoordinatorApi/update" method="put" nonvalidate>
            <?php
          foreach ($coordinator_profile as $profile)
          {?>
          ...
          <?php } } else {?>
            <form class="needs-validation" action="/CoordinatorApi/save" method="put" nonvalidate>
