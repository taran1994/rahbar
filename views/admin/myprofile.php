      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-9" id="myprofile">
          ...
          if(isset($admin_profile)){
            ?>
          <form class="needs-validation" action="/AdminApi/update" method="put" nonvalidate>
            <?php
          foreach ($admin_profile as $profile)
          {?>
          ...
          <?php } } else {?>
            <form class="needs-validation" action="/AdminApi/save" method="put" nonvalidate>
